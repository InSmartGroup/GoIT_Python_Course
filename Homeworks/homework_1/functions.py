...
def select_folder(folder_name):
    """
    Specifies the folder, which you need to process. If the folder doesn't exist, it will be created automatically.
    :param folder_name: The name of a folder you want to process.
    :type folder_name: str

    :return: A path to a specified folder.
    :rtype: pathlib.WindowsPath object
    """
